  ...
  return (
    <>
      <div className="text-center py-4">
        <h1>Thumbnail video</h1>
        <p>
          A great video thumbnail can mean the difference between getting a few
          views, and a few thousand views.
        </p>
      </div>
      <a href="https://www.youtube.com/watch?v=Z755vZBf9oM&pp=ygUObWFsZGl2ZXMgdmlkZW8%3D">
        <div
