...
import PriceDetels from "../Sections/HeavenlyJourneys";
import Image from "../Sections/imageVideo";
import Review from "../Sections/Review";
import Video from "../Sections/Video";
import YourStory from "../Sections/YourStory";
import Card from "../Sections/RecommendedForeign";
              ...
              >
                ...
                <div className="m-2">
                  <form className="d-flex" role="search">
                    ...
                    />
                    <button
                      className="btn btn-outline-danger fs-3 px-4 "
                      type="submit"
                    >
                      <Search size={40} />
                    </button>
